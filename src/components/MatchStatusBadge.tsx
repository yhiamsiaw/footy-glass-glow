...
export const MatchStatusBadge = ({ status, elapsed, className }: BadgeProps) => {
  ...
  const badgeClass = cn(
    "text-xs font-medium px-2 py-1 rounded-full text-center min-w-[32px] inline-block",
    {
      "bg-orange-500/20 text-orange-500": status === "LIVE",
      "bg-gray-600/20 text-gray-500": status === "FT",
      "bg-blue-600/20 text-blue-500": status === "UPCOMING",
      "bg-green-600/20 text-green-500": status === "HT",
    },
    className
  );
